...
function PageContainer({ children, style, title, isCustomLeftButton = false, renderLeftButton, onLeftButtonClick, navigationBarStyle, enableFlex = true }: {
  enableFlex?: boolean, children: any, style?: CSSProperties, title?: string, isCustomLeftButton?: boolean, renderLeftButton?: React.ReactElement, onLeftButtonClick?: () => void, navigationBarStyle?: object,
}) {
  if (!enableFlex) {
