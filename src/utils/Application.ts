...
class Application {
  ...
  themes1 = [
    ...
    { themePrimary: "#e59086", name: "" },
    { themePrimary: "#f2bd42", name: "" },
    { themePrimary: "#fef388", name: "" },
    { themePrimary: "#d7fc9d", name: "" },
    { themePrimary: "#bbfdec", name: "" },
    { themePrimary: "#d2eff7", name: "" },
    { themePrimary: "#b3cbf6", name: "" },
    { themePrimary: "#d0b1f6", name: "" },
    { themePrimary: "#f6d1e7", name: "" },
    { themePrimary: "#e2caac", name: "" },
  ];
  colors = [
    "#f44336",
    "#e91e63",
